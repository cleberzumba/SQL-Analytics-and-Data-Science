...
-- Gera dados randomicos na tabela
-- Stored Procedure de carga de dados
CREATE OR REPLACE PROCEDURE carregar_dados_contabeis()
LANGUAGE plpgsql
AS $$
DECLARE
    i INT;
...
BEGIN
    FOR i IN 1..1000 LOOP
        ...
        INSERT INTO lancamentoscontabeis (
            id, 
            data_lancamento, 
            conta_debito, 
            conta_credito, 
...
-- Executa a SP
call carregar_dados_contabeis();


-- Verifica os dados
SELECT * FROM lancamentoscontabeis;
